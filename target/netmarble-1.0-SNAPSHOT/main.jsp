...
<div class="main">
    <header class="header">
        <div class="gnb">
            <div class="logo_white on"><a href="main.jsp"><img src="./image/logo_white.png" alt="netmable"></a>
            </div>
            ...
            <div class="gnb_back">
                <ul class="gnb_ul flx">
                    ...
                    %>
                    <li>
                        <a href="login.jsp" class="lnb_title ">로그인</a>
                    </li>
                    <%
                    } else {
                    %>
                    <li>
                        <a href="logoutAction.jsp" class="lnb_title ">로그아웃</a>
                    </li>
                    <%
                        }
                    %>
